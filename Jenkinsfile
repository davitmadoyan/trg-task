    ...
    stages {
        ...
        stage('Push changes') {
            steps {
                ...
                sh 'cd trg-argocd-app-config; git add .; git commit -m "updated image version"; git push https://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@github.com/davitmadoyan/trg-argocd-app-config.git'
            }
        }
    }
}
