    ...
    stages {
        ...
        stage('Push changes') {
            steps {
                ...
                sh 'cd trg-argocd-app-config; git add .; git commit -m "updated image version"; git push https://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@github.com/davitmadoyan/trg-argocd-app-config.git'
            }
        }
    }
}
